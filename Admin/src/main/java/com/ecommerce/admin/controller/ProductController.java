...
public class ProductController {
    ...
    public String saveProduct(@ModelAttribute("product")ProductDto productDto,
        ...
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Не удалось добавить");
        }
    ...
    public String processUpdate(@PathVariable("id") Long id,
        ...
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Не удалось обновить");
        }
        return "redirect:/products/0";
    ...
    public String enabledProduct(@PathVariable("id")Long id, RedirectAttributes attributes){
        try {
            ...
            attributes.addFlashAttribute("success", "Включено успешно");
        }catch (Exception e){
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Не удалось включить");
        }
    ...
    public String deletedProduct(@PathVariable("id") Long id, RedirectAttributes attributes){
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Не удалось удалить");
        }
        return "redirect:/products";
    }
}
